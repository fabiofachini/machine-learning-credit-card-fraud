...
aleatorio_indice_normal = np.random.choice(indice_normal, 9348, replace = False) #criar variável que contenha o quantidade de não fraudes igual ao de fraude de forma aleatória
